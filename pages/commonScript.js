...
class CommonScripts extends Helper{
    ...
    async fetchPolicyID(data, index=0){
        ...
        let proposalList = await this.request(`https://sureos-policy-service.internal.ackodev.com/policy-service/v1/policies?userId=${await userID}`)
                                    .setHeader("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJzekY1YUowUDU3NXJsWlBsSTNJMGpFVU1yb3c5NERFZ2QwY1hadXNvN0ZRIn0..EShv1RdcXZnYqOWMKR89UXD8J5110hcf4efv_O3_hxRvp1CXgSPUUea-tz-0g0bOYE4ilkAtPJfastWTPbamVRkb9pE_3-J2sTc0aq5zMoozWWJ0K1TySr-6Ml-4iweXdAj8XGg1tRO9y4YArWKMXu3FJdD2C4BSdMGt9OYVwBo_jQTcSW3FbjLBimJCUiM4aZhyIoOeHQ9CxX77LVm7fs2C0toU-1RJxhFt9mh9nW7-lis3u1RICPqV6NIyYoaj5ImZTrupHnjicYIKUpEUcNfFMhHq-MO__NHZ1CAkzj7LETfz_li-6GUdUtOLQOF8epNR46lc2bZSvstXohYtNw")
                                    .get()
                                    .getResponse()
                                    .end();
